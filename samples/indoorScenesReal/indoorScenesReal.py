"""
Mask R-CNN
Configurations and data loading code for the synthetic indoor scenes dataset.
This is a duplicate of the code in the noteobook train_indoorscenes.ipynb for easy
